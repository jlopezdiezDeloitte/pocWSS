 ...
 * generated in the com.ejie.poc.alternativa.servicios package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSum_QNAME = new QName("http://servicios.alternativa.poc.ejie.com/", "calculateSum");
    private final static QName _CalculateSumResponse_QNAME = new QName("http://servicios.alternativa.poc.ejie.com/", "calculateSumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ejie.poc.alternativa.servicios
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://servicios.alternativa.poc.ejie.com/", name = "calculateSum")
     ...
     */
    @XmlElementDecl(namespace = "http://servicios.alternativa.poc.ejie.com/", name = "calculateSumResponse")
